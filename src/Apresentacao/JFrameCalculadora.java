...
public class JFrameCalculadora extends javax.swing.JFrame {
    ...
    public void inicializar() {
        ...
        this.setMarca("Minha calculadora");
        this.setModelo("0000000000000000");

        // Repassa  Marca e modelo para o formulário
        this.jLabelMarca.setText(this.getMarca());
        this.jLabelModelo.setText(this.getModelo());
    }
